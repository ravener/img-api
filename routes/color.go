...
// Copied from golang.org/x/image/colornames because screw Go modules.
// It's already installed indirectly from another dependency and I'm trying to work offline.
// But Go modules is so hungry for online checking everytime.
// I give it a 1/10 Go modules is totally crap for people who want to work offline.
